...
nohup java -server -jar $JAVA_OPTS -Dserver.port=7788 -Dmqtt.serverConfig.tcpPort=1883 -Dspring.profiles.active=test -Dmqtt.nettyConfig.epoll=false jo-mqtt-broker.jar>console.log 2>&1 &
echo "$!" > run.pid
echo "mqtt启动完成!"
